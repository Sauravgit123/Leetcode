...
# buys candies with costs 2 and 3, they can take the candy with cost 1 for free, but not the candy with cost 4.
...
# Auxiliary Space: O(1) (ignoring Python's internal sorting space)